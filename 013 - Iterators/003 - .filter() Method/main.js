...
const smallNumbers = randomNumbers.filter(smollNumero => {
  return smollNumero < 250
})
...
const longFavoriteWords = favoriteWords.filter(footLongWords => {
  return footLongWords.length > 7
})