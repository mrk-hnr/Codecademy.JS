...
groceryList.unshift("popcorn") //adds element at index 0

console.log(groceryList.slice(1,4)) // left number is that start of index, and the right number is the index of the last element to be sliced.
