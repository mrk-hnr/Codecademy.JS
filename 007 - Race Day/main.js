...
let earlyRegisteree = true
let runnerAge = 18

if (runnerAge > 18 && earlyRegisteree === true) {
  raceNumber += 1000
  console.log(`Race time is at start at 9:30, runner number ${raceNumber}`)
} else if (runnerAge > 18 && earlyRegisteree === false) {
  console.log(`Race time is at 11:00 AM, runner number ${raceNumber}`)
} else if (runnerAge < 18) {
  console.log(`Youth registrants will run at 12:30 PM, runner number ${raceNumber}`)
} else {
  console.log("If you are 18 years old, please see registration desk!")
}
